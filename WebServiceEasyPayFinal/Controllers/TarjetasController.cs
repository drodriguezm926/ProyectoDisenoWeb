...
using WebServiceEasyPayFinal.App_Data;

namespace WebServiceEasyPayFinal.Controllers
{
    public class TarjetasController : ApiController
    {
        private wseasyDB db = new wseasyDB();
        ...
        public IHttpActionResult PutTarjeta(Tarjeta tarjeta)
        {
            ...
            else
            {
                ...
                {
                    //Veridica el cod de usuario o contrasena
                    if (!data.codUsuario.Equals(tarjeta.codUsuario))
                    {
